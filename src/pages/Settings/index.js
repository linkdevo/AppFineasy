...
export default function Example() {
  ...
  return (
    <SafeAreaView style={{ backgroundColor: '#A855A0' }}>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          <Text style={styles.title}>Configurações</Text>

          <Text style={styles.subtitle}>
            Configurar e Editar Perfil
          </Text>
        </View>
        ...
        <View style={styles.profile}>
          ...
          <Text style={styles.profileName}>Alexandre Correa Link Junior</Text>

          <Text style={styles.profileEmail}>alexandre.junior@fineasytech.com</Text>
